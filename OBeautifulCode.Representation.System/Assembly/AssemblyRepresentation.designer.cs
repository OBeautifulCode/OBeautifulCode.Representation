...
namespace OBeautifulCode.Representation.System
{
    ...
    public partial class AssemblyRepresentation : IModel<AssemblyRepresentation>
    {
        ...
        public bool Equals(AssemblyRepresentation other)
        {
            ...
            var result = this.Name.Equals(other.Name, StringComparison.Ordinal)
                      && this.Version.Equals(other.Version, StringComparison.Ordinal)
                      && this.FilePath.Equals(other.FilePath, StringComparison.Ordinal)
                      && this.FrameworkVersion.Equals(other.FrameworkVersion, StringComparison.Ordinal);
