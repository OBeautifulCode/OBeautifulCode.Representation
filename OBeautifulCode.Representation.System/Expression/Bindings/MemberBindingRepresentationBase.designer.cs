...
namespace OBeautifulCode.Representation.System
{
    ...
    public partial class MemberBindingRepresentationBase : IModel<MemberBindingRepresentationBase>
    {
        ...
        public virtual MemberBindingRepresentationBase DeepCloneWithType(TypeRepresentation type)
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
        ...
        /// </returns>
        protected virtual MemberBindingRepresentationBase DeepCloneInternal()
        {
            throw new NotImplementedException("This method should be abstract.  It was generated as virtual so that you aren't forced to override it when you create a new model that derives from this model.  It will be overridden in the generated designer file.");
        }
