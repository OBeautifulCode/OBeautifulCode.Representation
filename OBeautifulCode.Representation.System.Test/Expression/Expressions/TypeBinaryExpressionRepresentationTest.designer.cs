...
namespace OBeautifulCode.Representation.System.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TypeBinaryExpressionRepresentation> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TypeBinaryExpressionRepresentation>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TypeBinaryExpressionRepresentation>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TypeBinaryExpressionRepresentation>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TypeBinaryExpressionRepresentation>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Representation.System.TypeBinaryExpressionRepresentation: NodeType = {systemUnderTest.NodeType.ToString() ?? "<null>"}, Type = {systemUnderTest.Type?.ToString() ?? "<null>"}, Expression = {systemUnderTest.Expression?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TypeBinaryExpressionRepresentation> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TypeBinaryExpressionRepresentation>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TypeBinaryExpressionRepresentation>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'type' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TypeBinaryExpressionRepresentation>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TypeBinaryExpressionRepresentation> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TypeBinaryExpressionRepresentation>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TypeBinaryExpressionRepresentation>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TypeBinaryExpressionRepresentation>
                        {
                            SystemUnderTest = new TypeBinaryExpressionRepresentation(
                                                      referenceObject.Type,
                                                      referenceObject.Expression),
        ...
        private static readonly DeepCloneWithTestScenarios<TypeBinaryExpressionRepresentation> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TypeBinaryExpressionRepresentation>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TypeBinaryExpressionRepresentation>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TypeBinaryExpressionRepresentation>().ThatIs(_ => !systemUnderTest.Type.IsEqualTo(_.Type));

                        var result = new SystemUnderTestDeepCloneWithValue<TypeBinaryExpressionRepresentation>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TypeBinaryExpressionRepresentation>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TypeBinaryExpressionRepresentation>().ThatIs(_ => !systemUnderTest.Expression.IsEqualTo(_.Expression));
        ...
        private static readonly TypeBinaryExpressionRepresentation ReferenceObjectForEquatableTestScenarios = A.Dummy<TypeBinaryExpressionRepresentation>();

        private static readonly EquatableTestScenarios<TypeBinaryExpressionRepresentation> EquatableTestScenarios = new EquatableTestScenarios<TypeBinaryExpressionRepresentation>()
            .AddScenario(() =>
                new EquatableTestScenario<TypeBinaryExpressionRepresentation>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TypeBinaryExpressionRepresentation[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new TypeBinaryExpressionRepresentation[]
                    {
                        new TypeBinaryExpressionRepresentation(
                                A.Dummy<TypeBinaryExpressionRepresentation>().Whose(_ => !_.Type.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Type)).Type,
                                ReferenceObjectForEquatableTestScenarios.Expression),
                        new TypeBinaryExpressionRepresentation(
                                ReferenceObjectForEquatableTestScenarios.Type,
                                A.Dummy<TypeBinaryExpressionRepresentation>().Whose(_ => !_.Expression.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Expression)).Expression),
                    },
        ...
        public static class Structural
        {
            ...
            public static void TypeBinaryExpressionRepresentation___Should_implement_IModel_of_TypeBinaryExpressionRepresentation___When_reflecting()
            {
                // Arrange
                var type = typeof(TypeBinaryExpressionRepresentation);

                var expectedModelMethods = typeof(IModel<TypeBinaryExpressionRepresentation>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TypeBinaryExpressionRepresentation>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TypeBinaryExpressionRepresentation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TypeBinaryExpressionRepresentation);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TypeBinaryExpressionRepresentation)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "NodeType", "Type", "Expression" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TypeBinaryExpressionRepresentation)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TypeBinaryExpressionRepresentation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                TypeBinaryExpressionRepresentation systemUnderTest1 = null;
                TypeBinaryExpressionRepresentation systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TypeBinaryExpressionRepresentation systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TypeBinaryExpressionRepresentation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TypeBinaryExpressionRepresentation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TypeBinaryExpressionRepresentation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TypeBinaryExpressionRepresentation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TypeBinaryExpressionRepresentation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
