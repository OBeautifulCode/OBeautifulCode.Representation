    ...
    public static partial class MemberExpressionRepresentationTest
    {
        ...
        public static class Structural
        {
            ...
            public static void MemberExpressionRepresentation___Should_implement_IModel_of_MemberExpressionRepresentation___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<MemberExpressionRepresentation>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.Expression.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(MemberExpressionRepresentation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
