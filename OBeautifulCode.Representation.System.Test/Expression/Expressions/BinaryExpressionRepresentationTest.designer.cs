    ...
    public static partial class BinaryExpressionRepresentationTest
    {
        ...
        public static class Structural
        {
            ...
            public static void BinaryExpressionRepresentation___Should_implement_IModel_of_BinaryExpressionRepresentation___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<BinaryExpressionRepresentation>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void BinaryExpressionRepresentation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(BinaryExpressionRepresentation);
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(BinaryExpressionRepresentation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
