    ...
    public static partial class UnaryExpressionRepresentationTest
    {
        ...
        public static class Structural
        {
            ...
            public static void UnaryExpressionRepresentation___Should_implement_IModel_of_UnaryExpressionRepresentation___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<UnaryExpressionRepresentation>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UnaryExpressionRepresentation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UnaryExpressionRepresentation);
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Operand == null)
                {
                    actual.Operand.AsTest().Must().BeNull();
                }
                else if (!actual.Operand.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(UnaryExpressionRepresentation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
